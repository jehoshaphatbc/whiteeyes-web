...
export default defineEventHandler(async (event) => {
  ...
  if (sql) {
    ...
    const [newItem] = await sql`
      INSERT INTO press_releases (
        ...
        current_title, current_points, quote_text, quote_author, personnel_body, personnel_members,
        ...
        ${body.release_date || ''}, ${body.genre || 'Extreme Death Metal'}, ${body.producer || 'WHITEEYES'}, ${body.label || 'Iron Tomb Records'},
        ...
        ${body.current_title || ''}, ${JSON.stringify(body.current_points || [])}, ${body.quote_text || ''}, ${body.quote_author || ''},
        ${body.personnel_body || ''}, ${JSON.stringify(body.personnel_members || [])}, ${body.video_embed_url || ''}, ${body.tracklist_info || ''},
        ${body.press_email || 'whiteeyes@gmail.com'}, ${body.meta_title || ''}, ${body.meta_description || ''}, ${body.meta_keywords || ''}, ${body.is_published !== false}
      )
      RETURNING *
    `
    return newItem
  ...
  const newItem = {
    ...
    genre: body.genre || 'Extreme Death Metal',
    producer: body.producer || 'WHITEEYES',
    ...
    press_email: body.press_email || 'whiteeyes@gmail.com',
