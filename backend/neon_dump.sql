-- ========================================================
-- WHITEEYES — NEON POSTGRESQL DATABASE EXPORT & SCHEMA
-- Paste this entire script into Neon SQL Editor (console.neon.tech)
-- ========================================================
...
-- 3. INSERT SEED DATA FOR WHITEEYES

-- Admin User (Email: admin@whiteeyes.metal / Password: Whiteeyes2026!)
INSERT INTO admin_users (id, email, password_hash, role) VALUES
(1, 'admin@whiteeyes.metal', '$2a$10$jPkEiU0QgyGItNwX1YBYmuR/Ph0D4Rd/YKwuSR4BaH.tGip/Cuufq', 'admin');

-- Band Profile
INSERT INTO band_profiles (id, band_name, genre_label, hero_tagline, hero_bg_image_url, spotify_url, youtube_url) VALUES
(1, 'WHITEEYES', 'Extreme Death Metal', 'CHRONICLES OF VISCERAL DECAY AND DISSOLUTION', 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=1920&auto=format&fit=crop', 'https://open.spotify.com/artist/06HL4z0CvFAxyc27GXpf02', 'https://www.youtube.com/watch?v=dQw4w9WgXcQ');
...
-- Videos
INSERT INTO videos (title, description, youtube_id, is_featured, sort_order) VALUES
('Chronicles of Decay (Official Video)', 'Official music video directed by Void Visuals. Shot on 16mm film.', 'L_LUpnjgPso', TRUE, 0),
('Live at Hammersonic Underground 2023', 'Full set performance live at Hammersonic Underground stage.', 'dQw4w9WgXcQ', FALSE, 1),
('Monolith of Filth (Live Rehearsal)', 'Raw multi-cam studio session recorded live in Jakarta.', '3JZ_D3ELwOQ', FALSE, 2);
